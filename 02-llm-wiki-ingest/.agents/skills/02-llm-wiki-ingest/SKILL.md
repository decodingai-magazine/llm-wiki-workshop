---
name: 02-llm-wiki-ingest
description: "Build and query an LLM-maintained wiki from notes, articles and GitHub repos, with one subagent per source (modes: ingest, query)."
---

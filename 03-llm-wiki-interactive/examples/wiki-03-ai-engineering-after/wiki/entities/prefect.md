...
- **FastMCP**: Prefect built it; FastMCP is the SDK used for both the MCP server and MCP client side in an agent architecture. [[03-llm-wiki-interactive/examples/wiki-ai-engineering-after/wiki/entities/fastmcp]]

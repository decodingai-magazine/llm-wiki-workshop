...
- Visualization tools are invoked by prompt, not by menu — "visualize my entire memory knowledge graph" is the interface. [[wiki/sources/queries-to-trigger-the-ui]]
